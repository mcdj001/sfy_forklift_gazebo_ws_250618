 ...
 * @LastEditTime: 2025-03-12 14:22:13
 * @FilePath: /sfy_forklift_gazebo_ws/src/sfy_ros/sfy_forklift_planner/sfy_forklift_local_planner/include/sfy_controller_algorithm/fuzzy_control.h
 * Copyright (c) 2024, GPL-3.0 license, Fengyuan Shen, All Rights Reserved.
 */
#ifndef __SFY_FUZZY_CONTROL_H
#define __SFY_FUZZY_CONTROL_H
#include <iostream>
#include <vector>
#include <algorithm>
#include <cmath>
...
private:
    ...
    void initFuzzySets() {
        ...
        // 输出模糊集
        x_k_sets = {
            {0.0, 0.0, 0.2},  // lowest          ZL
            {0.0, 0.2, 0.4},  // very_low        SL
            {0.2, 0.4, 0.6},  // extremely_low   VL
            {0.4, 0.6, 0.8},  // much_lower      ML
            {0.6, 0.8, 1.0},  // lower           L                   
            {0.8, 1.0, 1.2},  // below_average   LM
            {1.0, 1.2, 1.3},  // average         M
            {1.2, 1.3, 1.4},  // above_average   MH
            {1.4, 1.5, 1.6},  // higher          H
            {1.5, 1.6, 1.7},  // much_high       MH
            {1.6, 1.7, 1.8},  // very_high       VH
            {1.7, 1.8, 1.9},  // extremely_high  SH
            {1.8, 1.9, 1.9}   // highest         ZH
            // {0.5, 0.5, 0.6},  // lowest          ZL
            // {0.5, 0.6, 0.7},  // very_low        SL
            // {0.6, 0.7, 0.8},  // extremely_low   VL
            // {0.7, 0.8, 0.9},  // much_lower      ML
            // {0.8, 0.9, 1.0},  // lower           L                   
            // {0.9, 1.0, 1.2},  // below_average   LM
            // {1.0, 1.2, 1.3},  // average         M
            // {1.2, 1.3, 1.4},  // above_average   MH
            // {1.4, 1.5, 1.6},  // higher          H
            // {1.5, 1.6, 1.7},  // much_high       MH
