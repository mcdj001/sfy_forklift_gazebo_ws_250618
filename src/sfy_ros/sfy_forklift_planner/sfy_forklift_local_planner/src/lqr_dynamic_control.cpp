 ...
 * @LastEditTime: 2024-10-30 17:08:13
 * @FilePath: /sfy_forklift_gazebo_ws/src/sfy_ros/sfy_forklift_planner/sfy_forklift_local_planner/src/lqr_dynamic_control.cpp
...
LQR_Dynamic_Control::LQR_Dynamic_Control(){}
...
void LQR_Dynamic_Control::param_struct() {
	...
	double dx = x_d - x_car;
    double dy = y_d - y_car;
    double dtheta = mytools->normalizeAngle(yaw_d - yaw_car);
	...
	cout << "lateral_error:" << lateral_error << endl;
...
Matrix1x4 LQR_Dynamic_Control::cal_Riccati() {
	...
	double err = 0; //误差值
	double err_tolerance = 0.1;  //误差收敛阈值
	Matrix4x4 Qf = Q;
