 ...
 * @LastEditTime: 2024-06-20 17:10:17
 * @Description: Ayuan vscode 0.0
 */
#ifndef  SFY_MOTION_CONTROLLER_LQR_DYNAMIC_NODE_H
#define SFY_MOTION_CONTROLLER_LQR_DYNAMIC_NODE_H
...
private:
	...
	LQR_Dynamic_Control* controller;
    MyPath* path;
...
public:
    LQR_Dynamic_Node(ros::NodeHandle& nh);
    ~LQR_Dynamic_Node();
